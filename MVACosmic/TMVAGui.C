...
{   
   ...
   ActionButton( cbar,  
                 title,
                 Form( ".x mvas.C(\"%s\",static_cast<HistType>(0))", fName ),
   ...
   ActionButton( cbar,  
                 title,
                 Form( ".x mvas.C(\"%s\",static_cast<HistType>(3))", fName ),
   ...
   ActionButton( cbar,  
                 title,
                 Form( ".x mvas.C(\"%s\",static_cast<HistType>(1))", fName ),
   ...
   ActionButton( cbar,  
                 title,
                 Form( ".x mvas.C(\"%s\",static_cast<HistType>(2))", fName ),
